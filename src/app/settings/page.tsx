		...
		<>
			<main>
				<section className="border-b border-elevate-2">
					<Link
						href="/"
						className="flex gap-3 items-center text-foreground-2 p-3"
					>
						<svg
							xmlns="http://www.w3.org/2000/svg"
							width="15"
					...
					<div className="relative w-full max-w-3xl px-6 xl:px-0 mx-auto pb-6 md:pb-9 overflow-clip">
						...
						<svg
							...
							height="15"
							viewBox="0 0 15 15"
							className="fill-elevate-1 absolute right-0 -bottom-24 size-48 animate-spin"
				...
				<section className="max-w-3xl px-6 xl:px-0 mx-auto mt-12 flex flex-col gap-6">
					<fieldset className="bg-background border border-elevate-2 rounded-xl flex flex-col gap-2 p-5">
						<label
							className="text-foreground-2 font-medium text-lg"
							htmlFor="theme"
						>
							Theme
						</label>
					...
					<fieldset className="bg-background border border-elevate-2 rounded-xl flex flex-col gap-2 p-5">
						...
						<div className="text-sm">
							{searchEngine === "Google" ? (
								...
								<p>
									A private search engine that allows you to search on other
									sites or engines with so-called{" "}
									<Link
									...
									<span className="bg-elevate-2 text-foreground-2 px-0.5 rounded-sm">
										!
									</span>
								...
								<p>
									The search engine Microsoft desperately wants you to use. You
									can even earn rewards by using it, apparently.
								</p>
							) : (
								<p>
									My personal{" "}
									...
									instance that aggregates results from different engines. You
									can also search on other sites or engines with DuckDuckGo's
									Bangs by prefixing them with{" "}
									<span className="bg-elevate-2 text-foreground-2 px-0.5 rounded-sm">
										!!
									</span>
									.{" "}
					...
					<fieldset className="bg-background border border-elevate-2 rounded-xl flex flex-col gap-2 p-5">
						...
						>
							<Select.Trigger
								className="group relative inline-flex items-center justify-between w-full sm:w-56 px-3 py-2 overflow-clip ease-in-out outline-none hover:bg-elevate-1 border border-elevate-2 rounded-lg duration-100 hover:text-foreground-2"
					...
					<fieldset className="bg-background border border-elevate-2 rounded-xl flex flex-col gap-2 p-5">
						<div>
							...
							<p className="text-sm">
								Hide the seconds in digital clocks and the second hand in analog
								clocks.
							</p>
						</div>
						<Switch.Root
					...
					<fieldset className="bg-background border border-elevate-2 rounded-xl flex flex-col gap-2 overflow-clip">
						<div className="p-5">
							<div className="mb-2">
								<label
									className="text-foreground-2 font-medium text-lg"
								...
								<p className="text-sm">
									Override the font used for certain clocks with one that's
									installed locally on your system. Leave this field empty to
									use the default fonts.
								</p>
								<p className="text-sm">
									The font should support tabular numbers or be monospaced for
									best results.
								</p>
							</div>
							<div className="flex flex-col md:flex-row justify-between">
								<input
									type="text"
									className="group inline-flex items-center w-full sm:w-72 px-3 py-2 overflow-clip ease-in-out outline-none hover:bg-elevate-1 border border-elevate-2 rounded-lg duration-100 hover:text-foreground-2"
									id="customFont"
						...
						<div className="bg-elevate-1 flex justify-end p-3 text-sm">
							<button className="bg-foreground-2 text-background px-2 py-1 rounded-md">
								Apply
							</button>
						</div>
					</fieldset>
					<fieldset className="bg-background border border-elevate-2 rounded-xl flex flex-col gap-2 p-5">
						<div>
							<label
								className="text-foreground-2 font-medium text-lg"
								htmlFor="incrTimeCheckFreq"
							>
								Increase time check frequency
							</label>
							<p className="text-sm">
								By default, the current system time is checked every 1000 ms. If
								the seconds seem a little slow and/or the clocks occasionally
								skip a whole second, enable this option to check every 250 ms
								instead. This may improve the accuracy of the clocks.
							</p>
						</div>
						<Switch.Root
							className="group relative w-14 h-8 bg-transparent data-[state=checked]:bg-foreground-2 data-[state=unchecked]:hover:bg-elevate-1 outline-none rounded-full border data-[state=unchecked]:border-elevate-2 data-[state=checked]:border-foreground-2 duration-200"
