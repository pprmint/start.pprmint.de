    ...
    <>
      <main>
        ...
        <div id="main" className="max-w-3xl px-6 md:px-0 mx-auto mt-12 mb-24 flex flex-col gap-6">
          <section
            id="font"
            className="relative bg-background border border-elevate-2 rounded-xl flex flex-col gap-2 p-5"
          >
            <div className="mb-2">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3">
              <div className="flex flex-col gap-1">
                ...
                <div className="flex">
                  <input
                    type="text"
                    className="group inline-flex items-center w-full px-3 py-2 overflow-clip ease-in-out outline-none bg-transparent hover:bg-elevate-1 focus:bg-transparent border border-elevate-2 rounded-lg duration-100 text-foreground-2"
                    id="customFontFamily"
                    placeholder="Default"
