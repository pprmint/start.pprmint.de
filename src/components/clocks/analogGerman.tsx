	...
	return (
		<div className="relative size-64 border border-elevate-1 rounded-full shadow-inner">
			...
			<div className="absolute inset-0 drop-shadow-md">
				...
				>
					<div className="absolute bg-foreground-2 w-3.5 h-16 top-14 left-1/2 -translate-x-1/2" />
				</div>
				<div
					id="minute"
			...
			<div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 size-6 rounded-full bg-foreground-2" />
