...
function BahnClock() {
	...
	return (
		<div className="relative size-64 border border-slate-50 dark:border-neutral-800 rounded-full shadow-inner">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 186 186" className="absolute inset-2 fill-slate-950 dark:fill-neutral-100">
			...
			<div className="absolute inset-0 drop-shadow-md">
				...
				>
					<div className="absolute bg-slate-900 dark:bg-neutral-50 w-3.5 h-16 top-14 left-1/2 -translate-x-1/2" />
				</div>
				<div
					id="minute"
				...
				>
					<div className="absolute bg-slate-900 dark:bg-neutral-50 w-2.5 h-28 top-4 left-1/2 -translate-x-1/2" />
				</div>
				{lsHideSec !== "true" && (
					<div
						id="second"
			...
			<div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 size-6 rounded-full bg-slate-800 dark:bg-white" />
