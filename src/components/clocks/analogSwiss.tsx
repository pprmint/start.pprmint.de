export default function SwissClock({ time, large }: { time: number[], large?: boolean }) {
  ...
  return (
    <div className={`relative size-64 ${large && "lg:size-96 border-2"} border border-elevate-1 rounded-full shadow-inner duration-700 ease-in-out`}>
      ...
      <div className="absolute inset-0 drop-shadow-md">
        ...
        >
          <div className={`absolute bg-foreground-2 w-2.5 h-24 top-14 ${large && "lg:w-3.5 lg:h-36 lg:top-20"} left-1/2 -translate-x-1/2 duration-700 ease-in-out`} />
        </div>
        <div
          id="minute"
        ...
        >
          <div className={`absolute bg-foreground-2 w-1.5 h-32 top-6 ${large && "lg:w-2.5 lg:h-48 lg:top-8"} left-1/2 -translate-x-1/2 duration-700 ease-in-out`} />
        </div>
        {time[2] !== undefined && time[2] !== null && (
          ...
          >
            <div className={`absolute bg-accent w-1 h-28 top-12 ${large && "lg:w-2 lg:h-44 lg:top-16"} left-1/2 -translate-x-1/2 duration-700 ease-in-out`} />
            <div className={`absolute bg-accent size-5 top-10 ${large && "lg:size-7 lg:top-14"} left-1/2 -translate-x-1/2 rounded-full duration-700 ease-in-out`} />
          </div>
        )}
      </div>
