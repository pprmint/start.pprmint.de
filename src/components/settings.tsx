...
function Settings() {
	...
	const Clocks = ["Digital", "Digital (no animations)", "None"];
		...
		<Dialog.Root onOpenChange={() => refresh && location.reload()}>
			...
			<Dialog.Portal>
				...
				<Dialog.Content className="data-[state=open]:animate-dialog-enter data-[state=closed]:animate-dialog-exit fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-6 md:p-9 rounded-xl shadow-2xl bg-white dark:bg-neutral-950 border border-neutral-100 dark:border-neutral-900 size-full max-w-2xl md:h-max md:max-h-screen">
					...
					<Dialog.Description className="pb-3">Make changes to the start page here.</Dialog.Description>
					<fieldset className="min-h-20 flex items-center justify-between">
						<label className="text-neutral-950 dark:text-neutral-50" htmlFor="theme">
							Theme
						</label>
						<Select.Root
							value={theme}
						...
						>
							<Select.Trigger
								className="group capitalize relative inline-flex items-center justify-between h-full w-56 px-3 py-2 overflow-clip ease-in-out outline-none border border-neutral-100 dark:border-neutral-900 dark:hover:border-neutral-800 rounded-lg duration-100 hover:text-neutral-950 dark:hover:text-neutral-50"
					...
					<fieldset className="min-h-20 flex items-center justify-between">
						<div>
							<label className="text-neutral-950 dark:text-neutral-50" htmlFor="clock">
								Clock design
							</label>
						...
						>
							<Select.Trigger
								className="group relative inline-flex items-center justify-between h-full w-56 px-3 py-2 overflow-clip ease-in-out outline-none border border-neutral-100 dark:border-neutral-900 dark:hover:border-neutral-800 rounded-lg duration-100 hover:text-neutral-950 dark:hover:text-neutral-50"
					...
					<fieldset className="min-h-20 flex items-center justify-between">
						<div>
							<label className="text-neutral-950 dark:text-neutral-50" htmlFor="hideSec">
								Hide seconds
							</label>
							<p className="text-xs">Requires page refresh.</p>
						</div>
